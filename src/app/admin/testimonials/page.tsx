...
type EditingTestimonial = Partial<Omit<Testimonial, "_id" | "_creationTime">> & {
  _id?: Id<"testimonials">;
};

const emptyTestimonial: EditingTestimonial = {
  name: "",
  role: "",
  company: "",
  image: "",
...
export default function TestimonialsPage() {
  const testimonials = useQuery(api.testimonials.list, {}) as Testimonial[] | undefined;
  ...
  const deleteTestimonial = async (id: Id<"testimonials">) => {
  ...
  const togglePublished = async (t: Testimonial) => {
    try {
      await updateTestimonial({ id: t._id, published: !t.published });
    } catch {
      toast.error("Failed");
    }
  };
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 rounded-xl bg-emerald-500 text-black font-medium hover:bg-emerald-400"
        >
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        {testimonials === undefined ? (
          ...
          testimonials.map((t) => (
            <div key={t._id} className="bg-zinc-900/50 border border-zinc-800 rounded-2xl p-6">
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex gap-1">
                  ...
                  <span
                    className={`p-1.5 rounded-lg ${t.published ? "bg-green-500/20 text-green-400" : "bg-zinc-500/20 text-zinc-400"}`}
                  >
              ...
              <div className="flex gap-0.5 mb-3">
                {[1, 2, 3, 4, 5].map((star) => (
                  <Star
                    ...
                    size={14}
                    className={
                      star <= t.rating ? "fill-yellow-400 text-yellow-400" : "text-zinc-700"
                    }
                  />
                ))}
              </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-zinc-800/50 border border-zinc-700 text-white focus:outline-none"
                  >
                    {[5, 4, 3, 2, 1].map((r) => (
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 rounded-xl bg-zinc-800/50 border border-zinc-700 text-white focus:outline-none focus:border-emerald-500/50 resize-none"
                />
              </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-emerald-500 text-black font-semibold hover:bg-emerald-400"
              >
