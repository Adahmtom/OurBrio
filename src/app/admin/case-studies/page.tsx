...
type EditingStudy = Partial<Omit<CaseStudy, "_id" | "_creationTime">> & {
  _id?: Id<"caseStudies">;
};

const emptyStudy: EditingStudy = {
  title: "",
  slug: "",
  category: "",
  description: "",
...
export default function CaseStudiesPage() {
  const studies = useQuery(api.caseStudies.list, {}) as CaseStudy[] | undefined;
  const createStudy = useMutation(api.caseStudies.create);
  const updateStudy = useMutation(api.caseStudies.update);
  const removeStudy = useMutation(api.caseStudies.remove);
  ...
  const deleteStudy = async (id: Id<"caseStudies">) => {
  ...
  const togglePublished = async (study: CaseStudy) => {
    try {
      await updateStudy({ id: study._id, published: !study.published });
    } catch {
      toast.error("Failed");
    }
  };
            ...
            >
              <div className="relative h-48">
                ...
                <div className="absolute top-3 right-3 flex gap-2">
                  ...
                  <span
                    className={`p-1.5 rounded-lg ${study.published ? "bg-green-500/20 text-green-400" : "bg-zinc-500/20 text-zinc-400"}`}
                  >
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl bg-zinc-800/50 border border-zinc-700 text-white focus:outline-none focus:border-emerald-500/50"
                  placeholder="+150% Conversions, 2x Revenue"
                />
              </div>
