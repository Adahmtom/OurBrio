...
function HeroGeometric({
  ...
  description = "We design, build, and automate digital systems that help brands stand out and scale.",
  children,
}: HeroGeometricProps) {
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
              ...
              <span
                className={cn(
                  "bg-clip-text text-transparent bg-gradient-to-r from-emerald-300 via-green-200 to-teal-300"
                )}
              >
                {title2}
              </span>
